...
This specification defines the requirements for request tracing in the system. This includes generating unique request IDs for tracing purposes and propagating these IDs across all components and services involved in processing a request.
