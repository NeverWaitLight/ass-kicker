...
This capability handles adjustments to text colors in dark mode to ensure optimal readability and accessibility, particularly for specific background colors that may require special consideration.
