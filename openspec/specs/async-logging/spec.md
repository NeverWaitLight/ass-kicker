...
This specification defines the requirements for asynchronous logging in the system. This includes configuring loggers to operate asynchronously to improve performance and ensure efficient processing of log messages.
