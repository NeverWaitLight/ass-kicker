...
import com.github.waitlight.asskicker.channel.impl.SmtpAbstractChannelImpl;
...
class SmtpAbstractChannelImplTest {
    ...
    private SmtpAbstractChannelImpl channel;
    ...
    void setUp() throws Exception {
        ...
        channel = new SmtpAbstractChannelImpl(provider, WebClient.create(), ChannelTestObjectMappers.channelObjectMapper());
    }
