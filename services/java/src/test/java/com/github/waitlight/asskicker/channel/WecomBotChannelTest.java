...
import com.github.waitlight.asskicker.channel.impl.WecomBotChannel;
...
class WecomBotChannelTest {
    ...
    void send_success_getTokenThenAppChat() throws Exception {
        ...
        UniAddress address = UniAddress.ofImBot(ProviderType.WECOM_BOT, "ck", "chatid_1");
    ...
    void send_appChatFailure_returnsMappedException() {
        ...
        UniAddress address = UniAddress.ofImBot(ProviderType.WECOM_BOT, "k", "bad");
    ...
    void send_missingCorpId_returnsIllegalStateException() throws Exception {
        ...
        UniMessage message = new UniMessage();
        message.setContent("x");
        UniAddress address = UniAddress.ofImBot(ProviderType.WECOM_BOT, "k", "cid");
